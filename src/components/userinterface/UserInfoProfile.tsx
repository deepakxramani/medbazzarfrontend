    ...
    <div>
      ...
      >
          ...
          >
            ...
            >
              ...
              >
                <Avatar
                  src={picture.file}
                  style={{ width: 100, height: 100, border: '4px solid black' }}
                ></Avatar>
                <input
            ...
            <div>
              <h2 style={{ color: '#000', marginTop: 8, fontSize: 18 }}>
                {username}
              </h2>
              <h2 style={{ color: '#000', marginTop: 5, fontSize: 14 }}>
                {mobileno}
              </h2>
        ...
        <Grid
          item
          xs={12}
          style={{ marginTop: '30px 0px 10px 10px', padding: 30 }}
        >
