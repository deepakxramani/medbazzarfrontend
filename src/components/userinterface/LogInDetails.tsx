  ...
  return (
    ...
    >
      {status ? (
        <Paper
          elevation={5}
          style={{ width: '90%', borderRadius: '50px 10px' }}
        >
          <Grid
            container
            spacing={2}
          ...
          >
            <Grid item xs={11} sm={8} md={6}>
              ...
              <Grid item xs={12} style={{ marginTop: 20 }}>
                <Input
                  style={{ fontSize: 13, fontWeight: 'bold', letterSpacing: 3 }}
              ...
              >
                <div style={{ fontWeight: 'bold', fontSize: 15, margin: 5 }}>
                  +91 - {props.mobileno}
                </div>
                <Button
