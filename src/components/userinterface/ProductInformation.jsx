        ...
        <Grid container spacing={1}>
          <Grid item xs={12}>
            <div
              style={{
                ...
                width: 'auto',
                clipPath:
                  'polygon(100% 0, 80% 50%, 100% 100%, 0% 100%, 0 50%, 0% 0%)',
              }}
            >
              <p
                style={{
          ...
          >
            <div>
              <p
                style={{
                  fontSize: matchesMd ? 18 : 25,
                  fontWeight: 600,
                  marginRight: matchesMd ? 20 : 10,
                }}
              >
                {product?.productname} | {product?.productsubname} |{' '}
                {product?.weight}
                {product?.weighttype}
              </p>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <BookmarkAddOutlinedIcon
                style={{ fontSize: matchesMd ? 25 : 30, cursor: 'pointer' }}
              />
              <ShareOutlinedIcon
                style={{ fontSize: matchesMd ? 25 : 30, cursor: 'pointer' }}
              />
          ...
          >
            ...
            <span>•</span>
            <div
              style={{ background: '#99f6b4', padding: 8, borderRadius: 40 }}
            >
          ...
          >
            ...
            {product?.offerprice !== 0 ? (
              ...
              >
                <p
                  style={{ fontSize: 15, fontWeight: 500, padding: '5px 10px' }}
                >
                  {product?.offerprice !== 0 ? (
                    <div>
          ...
          <Grid item xs={12}>
            ...
            >
              <WatchLaterIcon
                style={{ fontSize: 18, marginRight: 3, marginTop: 3 }}
              />
              Delivery within{' '}
            ...
            <div style={{ display: 'flex', gap: 40, padding: '15px 0px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  width: matchesSM ? '100px' : '200px',
                  height: matchesSM ? '40px' : '50px',
                  padding: '10px 15px',
                  gap: 10,
                  fontSize: matchesSM ? 12 : 15,
                  fontWeight: 600,
                  color: '#fff',
                  background: '#228B22',
                  border: 'none',
              ...
              >
                CONTINUE {matchesSM ? '' : 'SHOPPING'}
                <LocalMallIcon
                  style={{ color: '#fff', fontSize: matchesSM ? 15 : 18 }}
                />
              </button>
            </div>
          </Grid>
