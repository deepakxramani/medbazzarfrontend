...
import PlusMinusComp2 from './PlusMinusComp2';
...
export default function ProductListing(props: any) {
  ...
  const productDetail = () => {
    ...
    return product.map((item: any, index: any) => {
      return (
        <div key={index} className='product-card'>
          ...
          >
            <p style={{ fontSize: 13, padding: '2px 5px', fontWeight: 500 }}>
              20% Off
            </p>
          </div>
          <div
          ...
          >
            <div
              ...
              style={{
                ...
                height: matchesSM ? 30 : matchesMd ? 35 : 30,
              }}
            >
              {item.productname} | {item.productsubname} | {item.weight}
              {item.weighttype}
            </div>
            <div
          ...
          >
            <WatchLaterIcon
              style={{ fontSize: matchesMd ? 12 : 18, marginRight: 3 }}
            />
            Delivery within{' '}
  ...
  return (
    ...
    >
      <span style={{ margin: 50 }}>All Products</span>
      <div
        style={{
          display: 'flex',
          flexWrap: 'wrap',
