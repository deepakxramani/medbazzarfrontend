...
export default function RegistrationPage() {
  ...
  const handleSubmit = async () => {
    var result = await postData('users/submit_user', {
      mobileno: mobileNo,
      emailid: emailId,
          ...
          >
            {status ? (
              ...
              >
                ...
                <p style={{ fontSize: 17, marginLeft: 3, fontWeight: 500 }}>
              ...
              >
                ...
                <p style={{ fontSize: 17, marginLeft: 3, fontWeight: 500 }}>
                  +91-<span style={{ fontWeight: 600 }}>{mobileNo}</span>{' '}
                  <span
                    style={{
                      color: '#2962ff',
                      fontWeight: 600,
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 30,
                  color: 'white',
                  background: isHover ? '#004361' : '#0078ad',
                  cursor: 'pointer',
                }}
              >
                {status ? 'Get Started' : 'Verify OTP'}
              </button>
              <p style={{ margin: 10 }}>
