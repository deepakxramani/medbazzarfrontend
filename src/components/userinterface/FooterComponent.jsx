    ...
    <Box sx={{ background: '#323a46', color: '#A0ABBB', padding: '70px 0px' }}>
      <Container maxWidth={'lg'}>
        <Grid container spacing={6}>
            ...
            >
              <div>
                <FacebookOutlinedIcon
                  style={{ color: '#A0ABBB', fontSize: 42 }}
                />
              </div>
              <div>
                <InstagramIcon style={{ color: '#A0ABBB', fontSize: 42 }} />
              </div>
              <div>
                <TwitterIcon style={{ color: '#A0ABBB', fontSize: 42 }} />
              </div>
              <div>
                <LinkedInIcon style={{ color: '#A0ABBB', fontSize: 42 }} />
              </div>
            </div>
          </Grid>
          ...
          <Grid item md={6} sm={12}>
            <div>
              <h4 style={{ color: '#A0ABBB', fontSize: 18 }}>
          ...
          <Grid item md={6} sm={12}>
            ...
            >
              ...
              >
                ...
                <Typography>
                  Over the last 15 years, we have touched the lives of lakhs of
                  Indian families by serving them with only the best quality and
                  genuine healthcare products. With over 300+ stores, a
                  comprehensive website and an easy-to-use app, it is only true
                  to say that Wellness Forever is the one-stop destination for
                  your wellness needs be it online or offline. Copyright
                  MedBazzar 2024.
                </Typography>
              </div>
            </div>
