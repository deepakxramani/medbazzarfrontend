...
export default function DisplayAllSubCategory() {
  ...
  const [error, setError] = useState<{ subCategory?: string; picture?: string }>({});
    ...
    Swal.fire({
      ...
      if (swalResult.isConfirmed) {
        ...
        var deleteResult = await postData(
          'subcategory/delete_subcategory_data',
          body,
        );
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    <span style={{ fontSize: 13, fontFamily: 'kanit' }}>
                      {error.subCategory}
                    </span>
                  }
  ...
  return (
    <div style={subcategoryStyle.mainBox}>
      <div style={subcategoryStyle.boxDisplay}>{showSubcategoryTable()}</div>
      {showSubcategoryForm()}
    </div>
  );
}
