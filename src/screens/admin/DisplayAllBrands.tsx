...
export default function DisplayAllBrands() {
  ...
  const [error, setError] = useState<{ brand?: string | null; picture?: string | null }>({});
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  error={!!error.brand}
                  helperText={
                    <span style={{ fontFamily: 'kanit', fontSize: 13 }}>
                      {error.brand}
                    </span>
                  }
  ...
  return (
    <div style={brandStyles.mainBox}>
      <div style={brandStyles.boxDisplay}>{ShowBrand()}</div>
      {showBrandForm()}
    </div>
  );
}
